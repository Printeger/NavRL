...
def test_actor_audit_rejects_velocity_map_slam_and_privileged_state_keys():
    ...
    for forbidden_key in [
        ...
        "r5e1_station_null_actual_world_speed_xy_mean",
        "evidence1_controller_latency_probe",
        "r5e2_collision_reason_code",
        "evidence2_collision_geometry_probe",
        "r5e3_residual_to_collision_threshold",
        "evidence3_braking_residual_probe",
        "r5g_station_null_mismatch_xy_mean",
        "r5g_anchor_error_mean_when_valid",
        "r5g_any_future_diagnostic",
        "r5h_collision_rate",
        "r5h_collision_window25_min_clearance_p05",
...
def test_ppo_actor_feature_extractor_source_uses_exact_actor_observation_keys():
    ...
    for forbidden_key in [
        ...
        "r5e_near_floor_rate",
        "r5e1_controller_command_w",
        "r5e1_collision_window25_actual_world_speed_xy_mean",
        "evidence1_actor_leak_probe",
        "r5e2_collision_window25_min_clearance_p05",
        "evidence2_actor_leak_probe",
        "r5e3_collision_window25_residual_to_collision_threshold_p05",
        "evidence3_actor_leak_probe",
        "r5g_station_null_mismatch_xy_mean",
        "r5g_anchor_error_mean_when_valid",
        "r5h_collision_rate",
        "r5h_collision_window50_ics_beta_mean",
        "r5h_station_null_prev_action_alignment_xy",
        "r5f_axis_split_gate",
